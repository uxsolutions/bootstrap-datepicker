...
A standalone .css file (including necessary dropdown styles and alternative, text-based arrows) can be generated by running `build/build_standalone.less` through the `lessc` compiler:
    ...
    $ lessc build/less/build_standalone.less datepicker.css

### SCSS
Same notice as above.

    $ sass build/scss/build_standalone.scss datepicker.css

If you're using the [bootstrap-sass](https://github.com/thomas-mcdonald/bootstrap-sass) gem by Thomas McDonald, simply prepend an underscore (to make it a partial) and import it after Bootstrap has been loaded.
