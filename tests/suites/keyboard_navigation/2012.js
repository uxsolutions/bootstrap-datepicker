...
test('by day (right/left arrows)', function(){
    ...
    datesEqual(this.dp.dates.get(-1), UTCDate(2012, 3, 1));
...
test('by week (up/down arrows)', function(){
    ...
    datesEqual(this.dp.dates.get(-1), UTCDate(2012, 2, 24));
    // Month not changed
    target = this.picker.find('.datepicker-days thead th.datepicker-switch');
    equal(target.text(), 'March 2012', 'Title is "March 2012"');
    ...
    datesEqual(this.dp.dates.get(-1), UTCDate(2012, 3, 7));
    target = this.picker.find('.datepicker-days thead th.datepicker-switch');
    equal(target.text(), 'April 2012', 'Title is "April 2012"');
});
...
test('by month, v1 (shift + left/right arrows)', function(){
    ...
    datesEqual(this.dp.dates.get(-1), UTCDate(2012, 3, 29));
    target = this.picker.find('.datepicker-days thead th.datepicker-switch');
    equal(target.text(), 'April 2012', 'Title is "April 2012"');
});
...
test('by year, v1 (ctrl + left/right arrows)', function(){
    ...
    datesEqual(this.dp.dates.get(-1), UTCDate(2011, 2, 31));
    // Month not changed
    target = this.picker.find('.datepicker-days thead th.datepicker-switch');
    ...
    datesEqual(this.dp.dates.get(-1), UTCDate(2013, 2, 31));
    target = this.picker.find('.datepicker-days thead th.datepicker-switch');
...
test('by year, from leap day', function(){
    ...
    datesEqual(this.dp.dates.get(-1), UTCDate(2011, 1, 28));
    // Month not changed
    target = this.picker.find('.datepicker-days thead th.datepicker-switch');
    ...
    datesEqual(this.dp.dates.get(-1), UTCDate(2012, 1, 28));
    target = this.picker.find('.datepicker-days thead th.datepicker-switch');
    equal(target.text(), 'February 2012', 'Title is "February 2012"');
    ...
    datesEqual(this.dp.dates.get(-1), UTCDate(2013, 1, 28));
    target = this.picker.find('.datepicker-days thead th.datepicker-switch');
