module('Mouse Navigation 2012 - Horizontal', {
    setup: function(){
        /*
...
test('Navigating next/prev by month when layout is horizontal', function(){
    var target;
...
test('Navigating to/from year view when layout is horizontal', function(){
    var target;
    ...
    target.click();
    // all pickers must remain visible when in horizontal layout
    ok(this.picker.find('.datepicker-years').is(':visible'), 'Days picker is visible');
    ok(this.picker.find('.datepicker-months').is(':visible'), 'Month picker is visible');
    ok(this.picker.find('.datepicker-years').is(':visible'), 'Years picker is visible');
    // viewMode doesn't change on horizontal layout
    equal(this.dp.viewMode, 0);
...
test('Navigating to/from decade view when layout is horizontal', function(){
    var target;
...
test('Navigating prev/next in year view when layout is horizontal', function(){
    var target;
...
test('Navigating prev/next in decade view when layout is horizontal', function(){
    var target;
