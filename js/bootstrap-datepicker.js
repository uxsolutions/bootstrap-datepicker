...
!function( $ ) {
	...
	var Datepicker = function(element, options) {
		...
		this.isInline = false;
		this.onDateRender = null || options.onDateRender;
	...
	Datepicker.prototype = {
		...
		fill: function() {
			...
			while(prevMonth.valueOf() < nextMonth) {
				...
				dateData.clsName = this.getClassNames(prevMonth);
				dateData.clsName.push('day');
				dateData.displayText = prevMonth.getUTCDate();

				dateData = typeof this.onDateRender == "function" ? this.onDateRender(dateData, prevMonth) : dateData;

				html.push('<td class="'+dateData.clsName.join(' ')+'">'+dateData.displayText+ '</td>');
