...
<html lang="en">
  <head>
    ...
    <script src="bootstrap-datepicker/js/locales/bootstrap-datepicker.bs.js" charset="UTF-8"></script>
    ...
    <script src="bootstrap-datepicker/js/locales/bootstrap-datepicker.eu.js" charset="UTF-8"></script>
    ...
    <script src="bootstrap-datepicker/js/locales/bootstrap-datepicker.fo.js" charset="UTF-8"></script>
    <script src="bootstrap-datepicker/js/locales/bootstrap-datepicker.fr.js" charset="UTF-8"></script>
    <script src="bootstrap-datepicker/js/locales/bootstrap-datepicker.fr-CH.js" charset="UTF-8"></script>
    ...
    <script src="bootstrap-datepicker/js/locales/bootstrap-datepicker.hy.js" charset="UTF-8"></script>
    ...
    <script src="bootstrap-datepicker/js/locales/bootstrap-datepicker.it-CH.js" charset="UTF-8"></script>
    ...
    <script src="bootstrap-datepicker/js/locales/bootstrap-datepicker.kh.js" charset="UTF-8"></script>
    ...
    <script src="bootstrap-datepicker/js/locales/bootstrap-datepicker.sr.js" charset="UTF-8"></script>
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <a class="brand navbar-brand" href="https://github.com/eternicode/bootstrap-datepicker">bootstrap-datepicker</a>
          <ul class="nav navbar-nav">
            <li class="active"><a href="#">Sandbox</a></li>
            <li><a href="http://bootstrap-datepicker.readthedocs.org/" taget="_blank">Read the Docs</a></li>
            <li><a href="https://github.com/eternicode/bootstrap-datepicker" taget="_blank">GitHub</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <h2>bootstrap-datepicker sandbox <small>&alpha;lph&alpha;</small></h2>
      ...
      <p>
        <a id="download-release" href="https://github.com/eternicode/bootstrap-datepicker/releases/download/v1.4.0/bootstrap-datepicker-1.4.0-dist.zip" class="btn btn-default">Download 1.4.0</a>
        <a id="download-master" href="https://github.com/eternicode/bootstrap-datepicker/zipball/master" class="btn btn-default">Download Development</a>
      </p>
      <style>
      ...
      <form class="form-inline sandbox-form" id="sandbox">
        <div class="well">
          ...
          <label for="format">Format
            <input class="span2 col-md-2 form-control" id="format" name="format" type="text" placeholder="mm/dd/yyyy"></label>
          <label for="weekStart">Week start
            <input class="span1 col-md-1 form-control" id="weekStart" name="weekStart" type="text" placeholder="0"></label>
          <label for="startDate">Start date
            <input class="span2 col-md-2 form-control" id="startDate" name="startDate" type="text" placeholder="-Infinity"></label>
          <label for="endDate">End date
            <input class="span2 col-md-2 form-control" id="endDate" name="endDate" type="text" placeholder="+Infinity"></label>
          <label for="startView">Start view
            <select class="span2 col-md-2 form-control" id="startView" name="startView">
          ...
          <label for="clearBtn" class="inline checkbox">Clear button
            <select class="span2 col-md-2 form-control" id="clearBtn" name="clearBtn">
              <option value="false">disabled</option>
          ...
          <label for="orientation">Orientation
            <select class="span2 col-md-2 form-control" id="orientation" name="orientation">
          ...
          <label for="multidateSeparator">Multidate separator
